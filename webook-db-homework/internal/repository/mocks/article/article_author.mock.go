...
//
//	mockgen -source=webook/internal/repository/article/article_author.go -package=repomocks -destination=webook/internal/repository/mocks/article/article_author.mock.go
//
...
func (m *MockArticleAuthorRepository) Create(ctx context.Context, author domain.Article) (int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArticleAuthorRepositoryMockRecorder) Create(ctx, author any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockArticleAuthorRepository)(nil).Create), ctx, author)
}

// Update mocks base method.
func (m *MockArticleAuthorRepository) Update(ctx context.Context, author domain.Article) error {
	m.ctrl.T.Helper()
...
func (mr *MockArticleAuthorRepositoryMockRecorder) Update(ctx, author any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockArticleAuthorRepository)(nil).Update), ctx, author)
}
