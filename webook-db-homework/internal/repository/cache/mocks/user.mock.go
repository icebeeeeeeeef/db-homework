...
// SetEmpty mocks base method.
func (m *MockUserCache) SetEmpty(ctx context.Context, id int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetEmpty", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetEmpty indicates an expected call of SetEmpty.
func (mr *MockUserCacheMockRecorder) SetEmpty(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetEmpty", reflect.TypeOf((*MockUserCache)(nil).SetEmpty), ctx, id)
}
