...
// Source: webook/pkg/ratelimit/limiter/types.go
//
// Generated by this command:
//
//	mockgen -source=webook/pkg/ratelimit/limiter/types.go -package=ratelimitmocks -destination=webook/pkg/ratelimit/limiter/mocks/types.mock.go
//
